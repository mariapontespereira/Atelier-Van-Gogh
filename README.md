...
**Paletas de Cores Temáticas:** Quatro conjuntos de cores baseados em obras como Noite Estrelada, Os Girassóis e o Retrato de Van Gogh e também uma paleta extra de cores.

**Gestão de Estados (Undo/Redo):** Histórico de até 20 ações para desfazer ou refazer traços.
...
**Noite Estrelada** (Azuis profundos e amarelos vibrantes)

**Os Girassóis** (Tons de amarelo, bege e verdes rústicos)

**Retrato de Van Gogh** (Verdes petróleo e tons de terra)
...
O Atelier é otimizado para um fluxo de trabalho rápido através do teclado:
          ...
          TECLA            |    AÇÃO
                           |
           1-6             |    Selecionar cores da paleta atual
                           |
           ...
           +/-             |    Aumentar / Diminuir tamanho do pincel
                           |
         shift +/-         |    Aumentar / Diminuir opacidade
                           |
          Z / X	           |    Desfazer / Refazer 
                           |
            M	           |    Alternar Tema (Claro/Escuro)
                           |
            S	           |    Guardar imagem (PNG)
                           |
            C	           |    Limpar tela inteira
                           |
...
HTML5 Canvas API - Renderização gráfica de alto desempenho.
